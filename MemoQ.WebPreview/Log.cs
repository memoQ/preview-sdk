...
namespace MemoQ.WebPreview
{
    public class Log
    {
        public static string PreviewUnavailableMessage = "Preview service of memoQ is unavailable. Please check the Options dialog of memoQ whether the external preview tools are allowed to connect.";
